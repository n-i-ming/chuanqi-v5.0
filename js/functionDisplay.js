function getMainSubTabDisplay(){
    ...
    if(player.mainTabId==0){//属性
        ...
        str+="<tr><td><玩了两周></td><td>挂机1209600次</td><td>挂机速度×2.5</td><td>"+(player.hangingTimeReal>=1209600?"已达成":"未达成")+"</td></tr>"
        str+="<tr><td><玩了三周></td><td>挂机1814400次</td><td>挂机速度×3</td><td>"+(player.hangingTimeReal>=1814400?"已达成":"未达成")+"</td></tr>"
        str+="<tr><td><玩了四周></td><td>挂机2419200次</td><td>挂机速度×5</td><td>"+(player.hangingTimeReal>=2419200?"已达成":"未达成")+"</td></tr>"
        str+="<tr><td>　</td></tr>"
        ...
        str+="<tr><td><无敌世间1></td><td>战力达到1e25000</td><td>挂机速度×5</td><td>"+(player.fightAbility.gte(n("1e25000"))?"已达成":"未达成")+"</td></tr>"
        str+="<tr><td><无敌世间2></td><td>战力达到1e30000</td><td>挂机速度×5</td><td>"+(player.fightAbility.gte(n("1e30000"))?"已达成":"未达成")+"</td></tr>"
        str+="<tr><td><无敌世间3></td><td>战力达到1e35000</td><td>挂机速度×5</td><td>"+(player.fightAbility.gte(n("1e35000"))?"已达成":"未达成")+"</td></tr>"
        str+="<tr><td><无敌世间4></td><td>战力达到1e40000</td><td>挂机速度×5</td><td>"+(player.fightAbility.gte(n("1e40000"))?"已达成":"未达成")+"</td></tr>"
        str+="<tr><td><无敌世间5></td><td>战力达到1e45000</td><td>挂机速度×5</td><td>"+(player.fightAbility.gte(n("1e45000"))?"已达成":"未达成")+"</td></tr>"
        str+="<tr><td><无敌世间6></td><td>战力达到1e50000</td><td>挂机速度×5</td><td>"+(player.fightAbility.gte(n("1e50000"))?"已达成":"未达成")+"</td></tr>"
        str+="</table>"
    }
        ...
        str+="</tr>"
        str+="<tr>"
        str+="<td style='width:300px;text-align:right'><button onclick='ZonghengUpgrade(0,1)' style='margin-left:-8px'>升100级</button><button onclick='ZonghengUpgrade(0,2)' style='margin-left:-8px'>升1万级</button><button onclick='ZonghengUpgrade(0,3)' style='margin-left:-8px'>升100万级</button><button onclick='ZonghengUpgrade(0,4)' style='margin-left:-8px'>升1亿级</button></td>"
        str+="<td style='width:20px'></td>"
        str+="<td style='width:300px;text-align:right'><button onclick='ZonghengUpgrade(1,1)' style='margin-left:-8px'>升100级</button><button onclick='ZonghengUpgrade(1,2)' style='margin-left:-8px'>升1万级</button><button onclick='ZonghengUpgrade(1,3)' style='margin-left:-8px'>升100万级</button><button onclick='ZonghengUpgrade(1,4)' style='margin-left:-8px'>升1亿级</button></td>"
        str+="</tr>"
        str+="<tr>"
        ...
        str+="</tr>"
        str+="<tr>"
        str+="<td style='width:300px;text-align:right'><button onclick='ZonghengUpgrade(2,1)' style='margin-left:-8px'>升100级</button><button onclick='ZonghengUpgrade(2,2)' style='margin-left:-8px'>升1万级</button><button onclick='ZonghengUpgrade(2,3)' style='margin-left:-8px'>升100万级</button><button onclick='ZonghengUpgrade(2,4)' style='margin-left:-8px'>升1亿级</button></td>"
        str+="<td style='width:20px'></td>"
        str+="<td style='width:300px;text-align:right'><button onclick='ZonghengUpgrade(3,1)' style='margin-left:-8px'>升100级</button><button onclick='ZonghengUpgrade(3,2)' style='margin-left:-8px'>升1万级</button><button onclick='ZonghengUpgrade(3,3)' style='margin-left:-8px'>升100万级</button><button onclick='ZonghengUpgrade(3,4)' style='margin-left:-8px'>升1亿级</button></td>"
        str+="</tr>"
        str+="<tr>"
        ...
        str+="</tr>"
        str+="<tr>"
        str+="<td colspan=3 style='text-align:right'><button onclick='ZonghengUpgrade(4,1)' style='margin-left:-8px'>升100级</button><button onclick='ZonghengUpgrade(4,2)' style='margin-left:-8px'>升1万级</button><button onclick='ZonghengUpgrade(4,3)' style='margin-left:-8px'>升100万级</button><button onclick='ZonghengUpgrade(4,4)' style='margin-left:-8px'>升1亿级</button></td>"
        str+="</tr>"
        str+="<tr>"
        ...
        str+="</tr>"
        str+="<tr>"
        str+="<td colspan=3 style='text-align:right'><button onclick='ZonghengUpgrade(5,1)' style='margin-left:-8px'>升100级</button><button onclick='ZonghengUpgrade(5,2)' style='margin-left:-8px'>升1万级</button><button onclick='ZonghengUpgrade(5,3)' style='margin-left:-8px'>升100万级</button><button onclick='ZonghengUpgrade(5,4)' style='margin-left:-8px'>升1亿级</button></td>"
        str+="</tr>"
        str+="</table>"
    }

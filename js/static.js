...
function addedPlayerData() { return {
    ...
    templeLv:[0,0,0],concealType:[],wingLv:[0,0],bookLv:[],
...
const subTabList=[
    ["属性","背包","丹药","兵器","元神","经脉","飞升","转生","神力","神庙","暗器","翅膀","功法"],
    ["新手村","乱葬岗","山贼寨","土匪窝","强盗帮","昆仑山","奇来峰","大秦山","缥缈林","流沙地","秋风原","望天峰","碧海谷","金银湖","猛虎穴","万寿山"],
]
const idToName={
...
const bagDisplayList=[2,3,6,8,10,0,5,11,15,1,4,7,9,12,13,14]
...
const bookAttribute=[
    ["凝元功",{criticalDamage:n(5)},{atk:n(20)},n(10000000),13],
    ["象甲功",{damageMinus:n(20)},{def:n(20)},n(15000000),14],
]

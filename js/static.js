...
const subTabList=[
    ...
    ["新手村","乱葬岗","山贼寨","土匪窝","强盗帮","昆仑山","奇来峰","大秦山","缥缈林","流沙地","秋风原"],
]
const idToName={
    0:"1品丹药",1:"铁矿",2:"元神修炼符",3:"银针",4:"白骨",5:"2品丹药",6:"琥珀",7:"树枝",8:"陨铁",9:"兽珠",10:"羽毛",11:"3品丹药"
}
const idFrom={
    0:"新手村-所有怪物",1:"新手村-牛",2:"新手村后的所有怪物",3:"新手村后的所有怪物",4:"乱葬岗-大骷髅",5:"土匪窝的所有怪物",6:"昆仑山后的所有怪物",7:"昆仑山-树妖9",
    8:"奇来峰后的所有怪物",9:"大秦山-云中兽9",10:"流沙地后的所有怪物"
}
const bagDisplayList=[2,3,6,8,10,0,5,11,1,4,7,9]
...
const meridianAttribute=[
    ...
    [850,4000,200],[1000,5000,200],[1200,6000,200]
]
